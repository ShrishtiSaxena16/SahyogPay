...
//               focus:ring-blue-400 focus:outline-none"
//             >
//               <option value="INR">Indian Rupee (India)</option>
...
const PaystackPayment = () => {
  ...
  const [currency, setCurrency] = useState('Indian Rupee'); // Default currency set to USD

  const handlePaystackPayment = async () => {
    const publicKey = 'pk_test_45bdb7cb44ed98f6981dd7e4dcdd3821eb7c104e'; // Replace with your Paystack public key
    const paymentHandler = window.PaystackPop.setup({
      key: publicKey,
      email,
